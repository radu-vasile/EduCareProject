...
namespace EduCare.Data.Migrations
{
    ...
    [Migration("20210419173435_NewTablesAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduCare.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("EduCare.Models.Announcement", b =>
                {
                    ...
                    b.Property<int?>("UserIDAccountID")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserIDAccountID");
            ...
            modelBuilder.Entity("EduCare.Models.Account", b =>
                {
                    b.HasOne("EduCare.Models.ApplicationUser", "User")
                        .WithOne("Account")
                        .HasForeignKey("EduCare.Models.Account", "UserID");
                });

            modelBuilder.Entity("EduCare.Models.Announcement", b =>
                {
                    b.HasOne("EduCare.Models.Account", "UserID")
                        .WithMany()
                        .HasForeignKey("UserIDAccountID");
                });
